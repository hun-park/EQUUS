...
HD_PWD='/home/hpark/equus/FPGA_TOP/FPGA_TOP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_top_wrapper.tcl -notrace
